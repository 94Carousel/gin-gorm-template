...
// NewLog Instances a Logger middleware that will write the logs to gin.DefaultWriter
// By default gin.DefaultWriter = os.Stdout
func NewLog() gin.HandlerFunc {
	return NewWithWriter(gin.DefaultWriter)
}

// NewWithWriter Instance a Logger middleware with the specified writter buffer.
...
func NewWithWriter(out io.Writer) gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		w.WriteString(" ")
		w.WriteString(c.Request.RequestURI)
		w.WriteString(" ")
